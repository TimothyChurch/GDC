  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminPageHeader, {
        ...
        subtitle: "Grains, sugars, yeast, and primary fermentation ingredients",
        icon: "i-lucide-wheat"
      }, {
      ...
      _push(ssrRenderComponent(_component_TableInventoryCategory, { category: "Base Ingredient" }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/inventory/ingredients.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ingredients-CDP7ujZA.mjs.map

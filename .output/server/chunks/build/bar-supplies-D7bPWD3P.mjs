  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminPageHeader, {
        title: "Bar Supplies",
        subtitle: "Mixers, garnishes, glassware, and bar tools",
        icon: "i-lucide-cup"
      }, {
      ...
      _push(ssrRenderComponent(_component_TableInventoryCategory, { category: "Bar Supplies" }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/inventory/bar-supplies.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=bar-supplies-D7bPWD3P.mjs.map

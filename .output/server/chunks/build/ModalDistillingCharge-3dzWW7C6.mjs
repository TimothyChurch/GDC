      ...
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div>`);
            if (!__props.forceRunType) {
              _push2(`<div${_scopeId}><div class="text-xs text-parchment/60 uppercase tracking-wider mb-2"${_scopeId}>Run Type</div><div class="flex gap-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UButton, {
            ...
            return [
              createVNode("div", { class: "space-y-5" }, [
                ...
                !__props.forceRunType ? (openBlock(), createBlock("div", { key: 0 }, [
...
//# sourceMappingURL=ModalDistillingCharge-3dzWW7C6.mjs.map

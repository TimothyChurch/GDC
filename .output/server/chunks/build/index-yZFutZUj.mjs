...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const distillingBatches = computed(
      () => batchStore.batches.filter(
        (b) => b.stages?.distilling?.startedAt || b.stages?.spiritRun?.startedAt || b.stages?.strippingRun?.startedAt
      ).length
    );
...
//# sourceMappingURL=index-yZFutZUj.mjs.map

  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminPageHeader, {
        title: "Bottling Supplies",
        subtitle: "Bottles, caps, labels, shrink wraps, and packaging materials",
        icon: "i-lucide-wine"
      }, {
      ...
      _push(ssrRenderComponent(_component_TableInventoryCategory, { category: "Bottling" }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/inventory/bottling.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=bottling-Cag5mISv.mjs.map

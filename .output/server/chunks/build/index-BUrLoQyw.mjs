...
import { defineComponent, ref, withCtx, createTextVNode, unref, createVNode, defineAsyncComponent, computed, mergeProps, isRef, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, toRaw, useSSRContext } from 'vue';
...
const LazyPanelVesselTransfer = defineAsyncComponent(() => import('./PanelVesselTransfer-Bos53yDq.mjs').then((r) => r["default"] || r.default || r));
...
//# sourceMappingURL=index-BUrLoQyw.mjs.map

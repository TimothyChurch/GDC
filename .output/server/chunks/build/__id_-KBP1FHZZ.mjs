...
import { _ as _sfc_main$r } from './Select-xxK8NqZT.mjs';
import { _ as _sfc_main$u } from './SiteDatePicker-pVMyeD61.mjs';
import { _ as _sfc_main$p } from './Input-Fd8Vd_4J.mjs';
import { _ as _sfc_main$s } from './FormField-DcXe0kwN.mjs';
import { _ as _sfc_main$q } from './Textarea-f7RIzcnS.mjs';
...
import { _ as _sfc_main$t } from './Badge-BJMjvXJU.mjs';
...
import { _ as _sfc_main$o } from './Modal-GBrZNdlF.mjs';
import { _ as __nuxt_component_2$1 } from './VesselCard-BZ02Pggy.mjs';
...
import { L as LazyPanelProduction } from './PanelProduction-D-myLrAb.mjs';
import { _ as __nuxt_component_0$1 } from './AdminPageHeader-Dox1yGAO.mjs';
import { _ as _sfc_main$v } from './Tooltip-wiUkEzv7.mjs';
import { _ as _sfc_main$w } from './SelectMenu-DljUyjmT.mjs';
import { v as volumeUnits } from './units-DWysHFem.mjs';
import { u as useBulkSpiritStore } from './useBulkSpiritStore-Bx2u4RsR.mjs';
import { L as LazyPanelBatch } from './PanelBatch-5FqvYiCg.mjs';
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_USelect = _sfc_main$r;
      const _component_SiteDatePicker = _sfc_main$u;
      const _component_UInput = _sfc_main$p;
      const _component_UFormField = _sfc_main$s;
      const _component_UTextarea = _sfc_main$q;
...
const __nuxt_component_0 = Object.assign(_sfc_main$n, { __name: "BatchMashing" });
...
const __nuxt_component_1 = Object.assign(_sfc_main$m, { __name: "BatchFermenting" });
  ...
  setup(__props, { emit: __emit }) {
    ...
    const completeRun = async () => {
      ...
      try {
        ...
        const stillId = batch?.stages?.[props.stageKey]?.vessel;
        if (stillId) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UIcon = _sfc_main$e$1;
      const _component_UBadge = _sfc_main$t;
      const _component_UButton = _sfc_main$8$1;
      const _component_UFormField = _sfc_main$s;
      const _component_USelect = _sfc_main$r;
      const _component_UInput = _sfc_main$p;
...
const __nuxt_component_4$2 = Object.assign(_sfc_main$l, { __name: "BatchDistillingRun" });
const LazyModalDistillingCharge = defineAsyncComponent(() => import('./ModalDistillingCharge-3dzWW7C6.mjs').then((r) => r["default"] || r.default || r));
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  __name: "BatchStrippingRun",
  __ssrInlineRender: true,
  props: {
    batch: {},
    editing: { type: Boolean }
  ...
  setup(__props) {
    ...
    const stage = computed(() => props.batch.stages?.strippingRun);
    ...
    const addRun = async () => {
      ...
      try {
        ...
        const newRun = {
          ...
          output: { vessel: "", volume: void 0, volumeUnit: "gallon", abv: void 0, proofGallons: void 0 }
        };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h3 class="text-lg font-bold text-parchment font-[Cormorant_Garamond]">Stripping Run</h3></div><div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5"><div><div class="text-xs text-parchment/60 uppercase tracking-wider mb-1">Still</div>`);
      if (__props.editing) {
        _push(ssrRenderComponent(_component_USelect, {
      ...
      _push(`</div><div><div class="text-xs text-parchment/60 uppercase tracking-wider mb-1">Start Date</div><div class="text-sm text-parchment">${ssrInterpolate(unref(startDate))}</div></div><div><div class="text-xs text-parchment/60 uppercase tracking-wider mb-1">Notes</div>`);
      if (__props.editing) {
        _push(ssrRenderComponent(_component_UTextarea, {
      ...
      _push(`<div class="grid grid-cols-3 gap-3 mb-5"><div class="bg-brown/10 rounded-lg p-3 text-center"><div class="text-xl font-bold text-parchment">${ssrInterpolate(unref(runCount))}</div><div class="text-xs text-parchment/50">Stripping Runs</div></div><div class="bg-brown/10 rounded-lg p-3 text-center"><div class="text-xl font-bold text-amber-400">${ssrInterpolate(unref(totalOutputVolume) > 0 ? unref(totalOutputVolume).toFixed(1) : "---")} `);
      if (unref(totalOutputVolume) > 0) {
        _push(`<span class="text-sm font-normal text-parchment/50">${ssrInterpolate(unref(totalOutputUnit) === "gallon" ? "gal" : unref(totalOutputUnit))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="text-xs text-parchment/50">Low Wines Output</div></div><div class="bg-brown/10 rounded-lg p-3 text-center"><div class="text-xl font-bold text-parchment">${ssrInterpolate(unref(avgAbv) > 0 ? unref(avgAbv).toFixed(1) + "%" : "---")}</div><div class="text-xs text-parchment/50">Avg ABV</div></div></div>`);
      ...
      if (unref(runs).length === 0) {
        _push(`<div class="text-center py-8 text-parchment/50 text-sm"> No stripping runs recorded yet. `);
        if (__props.editing) {
          _push(`<span>Use the button below to add a run.</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Batch/BatchStrippingRun.vue");
  return _sfc_setup$k ? _sfc_setup$k(props, ctx) : void 0;
};
const __nuxt_component_2 = Object.assign(_sfc_main$k, { __name: "BatchStrippingRun" });
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  __name: "BatchLowWines",
  __ssrInlineRender: true,
  props: {
    batch: {},
    editing: { type: Boolean }
  ...
  setup(__props) {
    const props = __props;
    const stage = computed(() => props.batch.stages?.lowWines);
    const strippingStage = computed(() => props.batch.stages?.strippingRun);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UIcon = _sfc_main$e$1;
      const _component_UBadge = _sfc_main$t;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-charcoal rounded-xl border border-amber-500/30 p-5" }, _attrs))}><div class="flex items-center gap-2 mb-4">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-beaker",
        class: "text-lg text-amber-400"
      }, null, _parent));
      _push(`<h3 class="text-lg font-bold text-parchment font-[Cormorant_Garamond]">Low Wines</h3>`);
      _push(ssrRenderComponent(_component_UBadge, {
        variant: "subtle",
        color: "warning",
        size: "xs"
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode("Holding")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div><div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5"><div><div class="text-xs text-parchment/60 uppercase tracking-wider mb-1">Date</div><div class="text-sm text-parchment">${ssrInterpolate(unref(startDate))}</div></div><div><div class="text-xs text-parchment/60 uppercase tracking-wider mb-1">Source</div><div class="text-sm text-parchment">${ssrInterpolate(unref(sourceRunCount))} stripping ${ssrInterpolate(unref(sourceRunCount) === 1 ? "run" : "runs")}</div></div></div><div class="rounded-lg border border-amber-500/20 bg-amber-500/5 p-5"><div class="text-xs text-parchment/60 uppercase tracking-wider mb-3">Accumulated Low Wines</div><div class="grid grid-cols-3 gap-4"><div class="text-center"><div class="text-2xl font-bold text-amber-400">${ssrInterpolate(unref(volume) > 0 ? unref(volume).toFixed(1) : "---")}</div><div class="text-xs text-parchment/50">${ssrInterpolate(unref(shortUnit))}</div></div><div class="text-center"><div class="text-2xl font-bold text-parchment">${ssrInterpolate(unref(abv) > 0 ? unref(abv).toFixed(1) + "%" : "---")}</div><div class="text-xs text-parchment/50">ABV</div></div><div class="text-center"><div class="text-2xl font-bold text-parchment">${ssrInterpolate(unref(proofGallons) > 0 ? unref(proofGallons).toFixed(2) : "---")}</div><div class="text-xs text-parchment/50">Proof Gallons</div></div></div></div>`);
      if (unref(stage)?.notes) {
        _push(`<div class="mt-4"><div class="text-xs text-parchment/60 uppercase tracking-wider mb-1">Notes</div><div class="text-sm text-parchment/60">${ssrInterpolate(unref(stage).notes)}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(volume) === 0) {
        _push(`<div class="text-center py-4 text-parchment/50 text-sm mt-4"> No low wines accumulated yet. Complete stripping runs to populate this stage. </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
_sfc_main$j.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Batch/BatchLowWines.vue");
  return _sfc_setup$j ? _sfc_setup$j(props, ctx) : void 0;
};
const __nuxt_component_3 = Object.assign(_sfc_main$j, { __name: "BatchLowWines" });
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  __name: "BatchSpiritRun",
  __ssrInlineRender: true,
  props: {
    batch: {},
    editing: { type: Boolean }
  ...
  setup(__props) {
    ...
    const stage = computed(() => props.batch.stages?.spiritRun);
    const runs = computed(() => stage.value?.runs || []);
    const vesselName = computed(() => {
      if (!stage.value?.vessel) return "Not assigned";
      return vesselStore.getVesselById(stage.value.vessel)?.name || "Unknown";
    ...
    const sourceVesselId = computed(() => {
      ...
      {
        const lowWinesStage = props.batch.stages?.[lowWinesKey];
        if (lowWinesStage?.vessel) return lowWinesStage.vessel;
      }
      return void 0;
    });
    const getRunIndex = (run) => runs.value.indexOf(run);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UButton = _sfc_main$8$1;
      const _component_BatchDistillingRun = __nuxt_component_4$2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-charcoal rounded-xl border border-rose-500/30 p-5" }, _attrs))}><div class="flex items-center gap-2 mb-4">`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-flask-round",
        class: "text-lg text-rose-400"
      }, null, _parent));
      _push(`<h3 class="text-lg font-bold text-parchment font-[Cormorant_Garamond]">Spirit Run</h3></div><div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5"><div><div class="text-xs text-parchment/60 uppercase tracking-wider mb-1">Still</div>`);
      if (__props.editing) {
        _push(ssrRenderComponent(_component_USelect, {
          modelValue: unref(localVessel),
          "onUpdate:modelValue": ($event) => isRef(localVessel) ? localVessel.value = $event : null,
      ...
      _push(`<div class="grid grid-cols-3 gap-3 mb-5"><div class="bg-brown/10 rounded-lg p-3 text-center"><div class="text-xl font-bold text-parchment">${ssrInterpolate(unref(runCount))}</div><div class="text-xs text-parchment/50">Spirit Runs</div></div><div class="bg-brown/10 rounded-lg p-3 text-center"><div class="text-xl font-bold text-rose-400">${ssrInterpolate(unref(heartsTotalVolume) > 0 ? unref(heartsTotalVolume).toFixed(1) : "---")} `);
      if (unref(heartsTotalVolume) > 0) {
        _push(`<span class="text-sm font-normal text-parchment/50">${ssrInterpolate(unref(heartsTotalUnit) === "gallon" ? "gal" : unref(heartsTotalUnit))}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="text-xs text-parchment/50">Hearts</div></div><div class="bg-brown/10 rounded-lg p-3 text-center"><div class="text-xl font-bold text-rose-400">${ssrInterpolate(unref(totalProofGallons).toFixed(2))}</div><div class="text-xs text-parchment/50">Proof Gallons</div></div></div>`);
      if (unref(runs).length >= 2 && !__props.editing) {
        _push(`<div class="flex justify-end mb-2">`);
        _push(ssrRenderComponent(_component_UButton, {
          icon: unref(allExpanded) ? "i-lucide-chevrons-down-up" : "i-lucide-chevrons-up-down",
      ...
      if (unref(runs).length === 0) {
        _push(`<div class="text-center py-8 text-parchment/50 text-sm"> No spirit runs recorded yet. `);
        if (__props.editing) {
          _push(`<span>Use the button below to add a run.</span>`);
        } else {
          _push(`<!---->`);
...
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Batch/BatchSpiritRun.vue");
  return _sfc_setup$i ? _sfc_setup$i(props, ctx) : void 0;
};
const __nuxt_component_4$1 = Object.assign(_sfc_main$i, { __name: "BatchSpiritRun" });
...
const __nuxt_component_5$1 = Object.assign(_sfc_main$h, { __name: "BatchDistilling" });
...
const __nuxt_component_6$1 = Object.assign(_sfc_main$g, { __name: "BatchMaceration" });
...
const __nuxt_component_7 = Object.assign(_sfc_main$f, { __name: "BatchFiltering" });
...
const __nuxt_component_5 = Object.assign(_sfc_main$d, { __name: "BatchBarrelSampling" });
...
const __nuxt_component_6 = Object.assign(_sfc_main$c, { __name: "BatchBarrelTastingNotes" });
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_BatchBarrelSampling = __nuxt_component_5;
      const _component_BatchBarrelTastingNotes = __nuxt_component_6;
      const _component_UTextarea = _sfc_main$q;
      const _component_UModal = _sfc_main$o;
      const _component_UFormField = _sfc_main$s;
      const _component_UInput = _sfc_main$p;
      const _component_USelect = _sfc_main$r;
...
const __nuxt_component_8 = Object.assign(_sfc_main$b, { __name: "BatchBarrelAging" });
...
const __nuxt_component_9 = Object.assign(_sfc_main$a, { __name: "BatchStorage" });
...
const __nuxt_component_10 = Object.assign(_sfc_main$9, { __name: "BatchBlending" });
...
const __nuxt_component_11 = Object.assign(_sfc_main$8, { __name: "BatchProofing" });
...
const __nuxt_component_12 = Object.assign(_sfc_main$7, { __name: "BatchBottled" });
...
const __nuxt_component_16 = Object.assign(_sfc_main$6, { __name: "BatchStepper" });
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UIcon = _sfc_main$e$1;
      const _component_UButton = _sfc_main$8$1;
      const _component_UTooltip = _sfc_main$v;
...
const __nuxt_component_18 = Object.assign(_sfc_main$5, { __name: "BatchPipelineEditor" });
...
const __nuxt_component_19 = Object.assign(_sfc_main$4, { __name: "BatchHeader" });
const LazyModalBarrelFill = defineAsyncComponent(() => import('./ModalBarrelFill-Dr42A5r-.mjs').then((r) => r["default"] || r.default || r));
  ...
  setup(__props, { emit: __emit }) {
    ...
    const advanceToDistilling = async () => {
      ...
      const result = await chargeModal.open({
        ...
        sourceVesselId,
        isFirstRun: true,
        defaultRunType: isStrippingRun ? "stripping" : isSpiritRun ? "spirit" : void 0,
      ...
      try {
        ...
        if (effectiveSource.value === "Upcoming") {
          ...
          await batchStore.advanceToStage(
            ...
            // Deduct full still charge from source (in batch units)
            effectiveSource.value,
            volInBatchUnit
    ...
    const completeToBulkStorage = async () => {
      ...
      try {
        ...
        const volumeUnit2 = vc?.volumeUnit || props.batch.batchSizeUnit || "gallon";
        const abv = vc?.abv || 0;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UModal = _sfc_main$o;
      const _component_UIcon = _sfc_main$e$1;
      const _component_USelectMenu = _sfc_main$w;
      const _component_NuxtLink = __nuxt_component_1$1;
      const _component_UInput = _sfc_main$p;
      const _component_USelect = _sfc_main$r;
      _push(`<!--[-->`);
                ...
                createVNode("div", { class: "p-5" }, [
                  ...
                  createVNode("div", { class: "grid grid-cols-2 gap-3 text-sm mb-4 rounded-lg border border-brown/30 p-3" }, [
                    createVNode("div", null, [
                      ...
                      createVNode("span", { class: "text-parchment ml-1" }, toDisplayString((unref(storageStageData).volume || 0).toFixed(1)) + " " + toDisplayString(unref(storageStageData).volumeUnit || __props.batch.batchSizeUnit), 1)
                    ]),
                    createVNode("div", null, [
...
const __nuxt_component_20 = Object.assign(_sfc_main$3, { __name: "BatchAdvanceAction" });
...
const __nuxt_component_22 = Object.assign(_sfc_main$2, { __name: "BatchTastingNotes" });
...
const __nuxt_component_23 = Object.assign(_sfc_main$1, { __name: "BatchActivityLog" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const STAGE_COMPONENTS = {
      ...
      "Stripping Run": __nuxt_component_2,
      "Low Wines": __nuxt_component_3,
      "Spirit Run": __nuxt_component_4$1,
      "Distilling": __nuxt_component_5$1,
      "Maceration": __nuxt_component_6$1,
      "Filtering": __nuxt_component_7,
      "Barrel Aging": __nuxt_component_8,
      "Storage": __nuxt_component_9,
      "Blending": __nuxt_component_10,
      "Proofing": __nuxt_component_11,
      "Bottled": __nuxt_component_12
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UButton = _sfc_main$8$1;
      const _component_BatchStepper = __nuxt_component_16;
      const _component_UModal = _sfc_main$o;
      const _component_BatchPipelineEditor = __nuxt_component_18;
      const _component_BatchHeader = __nuxt_component_19;
      const _component_BatchAdvanceAction = __nuxt_component_20;
      const _component_NuxtLink = __nuxt_component_1$1;
      const _component_BatchTastingNotes = __nuxt_component_22;
      const _component_BatchActivityLog = __nuxt_component_23;
...
//# sourceMappingURL=__id_-KBP1FHZZ.mjs.map

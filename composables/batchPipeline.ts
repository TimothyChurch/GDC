...
export function getNextStage(pipeline: string[], currentStage: string): string | null {
...
export function getPreviousStage(pipeline: string[], currentStage: string): string | null {
  const idx = pipeline.indexOf(currentStage);
...
export function hasReachedStage(pipeline: string[], currentStage: string, targetStage: string): boolean {
...
export function isCurrentStage(currentStage: string, targetStage: string): boolean {
...
const TEXT_COLOR_MAP: Record<string, string> = {
  ...
  copper: 'text-copper', emerald: 'text-emerald-400', sky: 'text-sky-400',
  amber: 'text-amber-400', purple: 'text-purple-400', pink: 'text-pink-400',
  cyan: 'text-cyan-400', green: 'text-green-400',
};

const BG_COLOR_MAP: Record<string, string> = {
  blue: 'bg-blue-500/10 border-blue-500/30', orange: 'bg-orange-500/10 border-orange-500/30',
  yellow: 'bg-yellow-500/10 border-yellow-500/30', copper: 'bg-copper/10 border-copper/30',
  emerald: 'bg-emerald-500/10 border-emerald-500/30', sky: 'bg-sky-500/10 border-sky-500/30',
  amber: 'bg-amber-500/10 border-amber-500/30', purple: 'bg-purple-500/10 border-purple-500/30',
  pink: 'bg-pink-500/10 border-pink-500/30', cyan: 'bg-cyan-500/10 border-cyan-500/30',

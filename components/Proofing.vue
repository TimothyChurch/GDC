		...
		<div class="flex flex-col gap-3 justify-center px-auto p-3">
			...
			<div class="grid grid-cols-2 gap-3 justify-center">
				<UFormGroup
					...
					<div class="grid grid-cols-2 gap-2">
						<UInput
							...
							@change="
								weightToAbv.kg = (
									convertUnitRatio('lb', 'kg') * weightToAbv.lbs
								).toFixed(2)
							">
						...
						<UInput
							...
							@change="
								weightToAbv.lbs = (
									convertUnitRatio('kg', 'lb') * weightToAbv.kg
								).toFixed(2)
							">
				...
				<UFormGroup
					...
					<div class="grid grid-cols-2 gap-2">
						<UInput
							type="number"
							v-model="weightToAbvGallons"
							disabled>
							<template #trailing> gal </template>
						</UInput>
						<UInput
							type="number"
							v-model="weightToAbvLiters"
							disabled>
			...
			<div class="grid grid-cols-1 gap-3 justify-center">
				<UFormGroup
					...
					<div class="grid grid-cols-2 gap-1">
						<UInput
							...
							@change="
								proofingDown.liter = (
									convertUnitRatio('gallon', 'L') * proofingDown.gallon
								).toFixed(2)
							">
							<template #trailing> gal </template>
						</UInput>
						<UInput
							...
							@change="
								proofingDown.gallon = (
									convertUnitRatio('L', 'gallon') * proofingDown.liter
								).toFixed(2)
							">
							<template #trailing> L </template>
						</UInput>
				...
				<UFormGroup
					...
					<UInput
						type="number"
						v-model="proofingDown.initialAbv" />
				</UFormGroup>
				<UFormGroup
					label="Target ABV"
					class="col-span-1">
					<UInput
						type="number"
						v-model="proofingDown.targetAbv" />
				</UFormGroup>
				<UFormGroup
					label="Target Volume"
					class="col-span-1">
					<div class="grid grid-cols-2 gap-1">
						<UInput
							type="number"
							v-model="proofingDownVolumeGallons"
							disabled>
							<template #trailing> gal </template>
						</UInput>
						<UInput
							type="number"
							v-model="proofingDownVolumeLiters"
							disabled>
							<template #trailing> L </template>
						</UInput>
					</div>
			...
			<div class="grid grid-cols-1 gap-3 justify-center">
				<UFormGroup
					...
					<UInput
						type="number"
						v-model="stepProofing.initialAbv" />
				</UFormGroup>
				<UFormGroup
					label="Water Added"
					class="col-span-1">
					<div class="grid grid-cols-2 gap-1">
						...
						<UInput
							...
							@change="
								stepProofing.waterAddedGallon = (
									convertUnitRatio('L', 'gallon') * stepProofing.waterAddedLiter
								).toFixed(2)
							">
							<template #trailing> L </template>
						</UInput>
				...
				<UFormGroup
					...
					<UInput
						type="number"
						v-model="stepProofing.targetAbv" />
				</UFormGroup>
				<UFormGroup
